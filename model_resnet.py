...
import logging
from model_crnn import ConvModel, ModelCRNN_LQ
...
class ResnetModel(ConvModel):
    ...
    def __init__(
        ...
        self.bottleneck = train_config.resnet_params.bottleneck
        if self.bottleneck:
            if resnet_version == 1:
        ...
        self.num_filters = train_config.resnet_params.num_filters

        self.kernel_size = train_config.resnet_params.kernel_size

        self.conv_stride = train_config.resnet_params.conv_stride
    ...
    def _build_model(self):
        ...
        layer = tf.identity(layer, "initial_conv")
        ...
        layer = tf.identity(layer, "initial_max_pool")
